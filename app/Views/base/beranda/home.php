    ...
    <div class="container align-items-end justify-content-center d-flex">
      <div class="row align-items-top text-left">
        <div class="col-12 col-md-6 col-lg-6">
          ...
          <p class="lead subjudul">Gratis undangan digital dengan syarat dan ketentuan yang berlaku.</p>
          <p class="mt-4"><a href="<?= base_url() ?>/order" class="btn btn-light btn-pesan">Hubungi</a></p>
      ...
      <div class="row mt-5 align-items-center justify-content-center">
        <div class="col-md-8 col-lg-4">
          <div class="fdb-box">
            <div class="row no-gutters align-items-center">
              <div class="col-3">
                <img alt="image" class="img-fluid rounded" src="<?php echo base_url() ?>/assets/base/img/people/1.png">
              </div>
            ...
            <div class="row mt-4">
              <div class="col-12">
                <p class="lead">
                  "Yang kami rasa dari sisi pelayanan jasa, respon itu asik bgt.. Tdk ada kata tidak / penolakan mengenai smua yg diinginkan oleh Calon mempelai..baik perubahan atau penambahan..dan yg aku suka segala perubahan tidak selalu disikapi dgn emosi atau komersial.. Jadi calon pengantin ngga stres2 bgt sebab WO-nya masih bs dinegosiasi dan diajak rembuk.."
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-8 col-lg-4 mt-4 mt-lg-0">
          <div class="fdb-box">
            <div class="row no-gutters align-items-center">
              <div class="col-3">
                <img alt="image" class="img-fluid rounded" src="<?php echo base_url() ?>/assets/base/img/people/3.png">
              </div>
              <div class="col-8 ml-auto">
                <p>
                  <strong>Yuyun</strong><br>
                </p>
              </div>
            </div>
            <div class="row mt-4">
              <div class="col-12">
                <p class="lead">
                  "Terimakasih sebelum &amp; sesudahnya untuk Biela Make Up yang sudah membantu pernikahan saya dari akad sampai dengan resepsi...dandanan nya sangat memuaskan cantik &amp;amp; pangling orang2 pada bilang cantik...gut luck ya Tim Biela Make Up"
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-8 col-lg-4 mt-4 mt-lg-0">
          <div class="fdb-box">
            <div class="row no-gutters align-items-center">
              <div class="col-3">
                <img alt="image" class="img-fluid rounded" src="<?php echo base_url() ?>/assets/base/img/people/2.png">
              </div>
              <div class="col-8 ml-auto">
                <p>
                  <strong>Siska</strong><br>
                </p>
              </div>
            </div>
            <div class="row mt-4">
              <div class="col-12">
                <p class="lead">
                  "Kami merasa puas dng Rias &amp; Dekorasinya. Smg Biela Make Up semakin sukses 🤲🤲🤲, Salam &amp; hormat serta maaf kami beserta klg."
                </p>
              </div>
            </div>
          </div>
    ...
    <div class="container">
      <div class="col-12 text-lg-left">
        <p class="lead footer-social">
          <a href="https://web.facebook.com/profile.php?id=100022511773102" class="mx-2"><i class="lni-facebook-filled" aria-hidden="true"></i></a>
          <a href="https://www.instagram.com/biela.makeup/" class="mx-2"><i class="lni-instagram-filled" aria-hidden="true"></i></a>
        </p>
      </div>
      <div class="row text-center">
        <div class="col">
          <p class="text-footer" style="color:#fff;">&#169;2022 <a href="<?php echo base_url() ?>" rel="dofollow" target="_blank"><?= SITE_NAME ?></a> </p>
        </div>
      </div>
    </div>
  </footer>
