...
<script type="text/javascript">
  ...
  $(function() {
    ...
    moment.locale('id');
    var tanggalAkad_ = '<?php if (isset($_SESSION['tanggal_akad'])) echo $_SESSION['tanggal_akad'];
                        else echo 0; ?>';
    if (tanggalAkad_ != '0') {
    ...
    var tanggalResepsi_ = '<?php if (isset($_SESSION['tanggal_resepsi'])) echo $_SESSION['tanggal_resepsi'];
                            else echo 0; ?>';
    ...
    myDropzone.on("sending", function(file, xhr, formData) {
      $('.dz-preview').remove();
      formData.append("data", "<?php if (isset($_SESSION['dummy'])) {
                                  echo $_SESSION['dummy'];
                                } ?>");
      $('#loading').show();
    });
    ...
    $(document).on('click', '.btnhehe', function() {
      ...
      var button_id = $(this).attr("id");
      var dummy = "<?php if (isset($_SESSION['dummy'])) {
                      echo $_SESSION['dummy'];
                    } ?>";
      $.ajax({
        type: 'POST',
