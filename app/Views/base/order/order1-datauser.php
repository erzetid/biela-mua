          ...
          <form action="<?php echo base_url('order/2') ?>" method="post">
            <div class="row align-items-center">
              <div class="col mt-4">
                ...
                <label style="bottom: -12.3px;position: inherit;padding-left: 20px;color: #005CAA;font-weight: bold;display: table;margin-bottom: -1.2rem;">undangan.bielamakeup.my.id/</label>
                <input name="domain" type="text" class="form-control" placeholder="akudandia" style="padding-left: 215px;" value="<?php echo $domain; ?>" onkeyup="nospaces(this)" required>
              </div>
            </div>
